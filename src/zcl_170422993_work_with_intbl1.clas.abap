CLASS zcl_170422993_work_with_intbl1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422993_work_with_intbl1 IMPLEMENTATION.
...
********************************************************
     ...
     connection = connections[ airport_from_id = 'SFQ' airport_to_id = 'SIN' ].
