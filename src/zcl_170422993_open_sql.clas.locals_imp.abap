...
*--------------------------------------------------
  METHOD insert_data.
    DATA: lt_insert TYPE TABLE OF ztcon_170422993.
    ...
    INSERT ztcon_170422993 FROM TABLE @lt_insert.
...
*--------------------------------------------------
  METHOD read_data.
    DATA: lt_result TYPE TABLE OF ztcon_170422993.
...
*--------------------------------------------------
  METHOD update_data.
    ...
    DATA: lt_update TYPE TABLE OF ztcon_170422993.
    ...
    UPDATE ztcon_170422993 FROM TABLE @lt_update.
...
*--------------------------------------------------
  METHOD delete_data.
    DATA: lt_delete TYPE TABLE OF ztcon_170422993.

    lt_delete = VALUE #( ( uuid = '763C8701C43C1FE18B8156AF50422DE0' ) ).

    DELETE ztcon_170422993 FROM TABLE @lt_delete.
